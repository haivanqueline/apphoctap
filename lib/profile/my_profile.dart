...
import 'package:learn_megnagmet/profile/saved_cource.dart';  // Import SavedCourses
...
class _MyProfileState extends State<MyProfile> {
  ...
  List profileOptionClass = [
    MyCertification(),
    MyProject(),
    SavedCoursesScreen(), // Thêm SavedCourses vào danh sách
    CertificatePayment(),
    HelpCenter(),
    PrivacyPolicy(),
    FeedBack(),
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  // Điều hướng đến SavedCourses khi index là 2
                                  if (index == 2) {
                                    Get.to(SavedCoursesScreen()); // Điều hướng đến SavedCourses
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Image(image: AssetImage("assets/right_arrow.png"), height: 24.h, width: 24.w),
                                        ),
                                      ],
                                    )),
                              ),
