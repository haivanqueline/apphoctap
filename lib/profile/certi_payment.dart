          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 15.w),
                Text("Payment", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 24.sp)),
              ],
            ),
            Expanded(
      ...
      onTap: () {
        Get.bottomSheet(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.only(topLeft: Radius.circular(22.h), topRight: Radius.circular(22.h)),
          ),
          CardBottomSheet(),
        ).then((_) => _fetchCreditCards()); // Làm mới danh sách thẻ sau khi thêm
      },
      child: Padding(
        ...
        child: Container(
          ...
          child: Center(
            child: Text("Add New Card", style: TextStyle(color: Color(0XFFFFFFFF), fontSize: 18.sp, fontWeight: FontWeight.w700)),
          ),
        ),
      ),
    );
